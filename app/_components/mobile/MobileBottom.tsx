...
export default function MobileBottom() {
  return (
    <nav className="fixed bottom-0 left-0 w-full h-20 bg-white backdrop-blur-md border-t border-zinc-800/40 flex md:hidden items-center justify-around px-4 pb-4 pt-2 z-40">
