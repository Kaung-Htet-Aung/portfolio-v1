export default function DesktopTop() {
  return (
    <header className="relative z-10 w-full md:h-20 h-8 md:border-b dark:border-[#F8843F]/30  border-zinc-700/50 flex items-start md:items-center justify-between px-8">
